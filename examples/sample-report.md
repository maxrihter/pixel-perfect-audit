...
**Viewport:** 1440 × 900
**Auditor:** Claude Code + pixel-perfect skill v2.1.0
...
| Settings (/settings) → Account section → Heading "Account" | Section heading | color #6B7280 not in palette. R:107→108(1), G:114→108(6), B:128→121(7) — G,B exceed 3 | Colors | High | #6B7280 | #6C6C79 (Secondary Text) |
...
*Generated by [claude-pixel-perfect-agent](https://github.com/maxrihter/claude-pixel-perfect-agent) v2.1.0*
